...
namespace JeffersonGoncalves\Erp\Buying\Tests;
...
abstract class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(function (string $modelName): string {
            ...
            foreach (['Buying', 'Stock', 'Accounting', 'Core'] as $package) {
            ...
            return "JeffersonGoncalves\\Erp\\Buying\\Database\\Factories\\{$basename}Factory";
        });
    }
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $configPath = __DIR__.'/../config/erp-buying.php';
        if (file_exists($configPath)) {
            $app['config']->set('erp-buying', require $configPath);
        }
    }

    protected function defineDatabaseMigrations(): void
    {
        $tempPath = sys_get_temp_dir().'/laravel-erp-buying-migrations';
        ...
        // across the core, accounting, stock and buying packages (core first,
        // then accounting, then stock, then buying).
        $ordered = array_merge(
